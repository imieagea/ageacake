...
echo $this->Form->create('Post',array('url'=>'/admin/view_actualite/'.$actu['Post']['id'])); ?>
	...
	<?php
		...
		echo $this->Form->input('video',array('value'=>$actu['Post']['video']));
		echo $this->Form->input('type_video',array('value'=>$actu['Post']['type_video'],'options'=>array('youtube'=>'Youtube','dailymotion'=>'Dailymotion'),'empty'=>true));
	?>
	</fieldset>

...
<div class="actions">
	<ul>
		<li><?php echo $this->Html->link(__('Editer', true), array('plugin' => 'full_calendar', 'action' => 'edit', $event['Event']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('Supprimer', true), array('plugin' => 'full_calendar', 'action' => 'delete', $event['Event']['id']), null, sprintf(__('Etes-vous sûr de vouloir supprimer l\'évènement %s ?', true), $event['EventType']['name'])); ?> </li>
		<li><?php echo $this->Html->link(__('Gérer les évènements', true), array('plugin' => 'full_calendar', 'action' => 'index')); ?> </li>
		<li><li><?php echo $this->Html->link(__('Voir le calendrier', true), array('plugin' => null, 'controller' => 'admin','action'=>'agenda')); ?></li>
	</ul>
</div>
